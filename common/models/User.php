...
//        return 1;
    ...
    public static function getNumberNotification(){
        return count(ThongBao::find()
            ->andFilterWhere(['user_id' => Yii::$app->user->id, 'active' => 1, 'is_seen' => 0])
