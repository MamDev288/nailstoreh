...
$this->title = 'Danh sách bảng lương của tôi';
...
<div class="chi-tiet-bang-luong-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'pjax' => true,
            'columns' => require(__DIR__ . '/../chi-tiet-bang-luong/_columns.php'),
            'toolbar' => [
                ['content' =>
                    ExportMenu::widget([
                        'dataProvider' => $dataProvider,
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách bảng lương',
                'after' =>
