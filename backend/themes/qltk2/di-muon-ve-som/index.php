...
$this->title = 'Đơn xin đi muộn về sớm';
...
<div class="nghi-phep-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Tạo đơn xin đi muộn về sớm', ['create'],
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách đơn xin đi muộn về sớm',
                'before'=>'<em>*</em>',
                'after'=>
