...
class Select2 extends InputWidget
{
    ...
    public function registerAssetBundle()
    {
        ...
        \kartik\select2\Select2Asset::register($view)->addLanguage($lang, '', 'js/i18n');
        if (in_array($this->theme, self::$_inbuiltThemes)) {
            /**
             * @var ThemeAsset $bundleClass
             */
            $bundleClass = 'kartik\select2\Theme'.Inflector::id2camel($this->theme).'Asset';
